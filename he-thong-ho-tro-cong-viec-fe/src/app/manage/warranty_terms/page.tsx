...
import Add_WarrantyTerm_Dialog from "./addDialong";
import Edit_WarrantyTerm_Dialog from "./editDialong";
...
import { deleteWarrantyTerm, fetchWarrantyTerm } from "@/store/slices/warrantytermsc/warrantytermAction";
...
const arr = [
  ...
  { title: "Điều khoản bảo hành", href: "/manage/warrantyTerm" },
];

export default function PagePage() {
  const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
  // API tác nhân
  const { items, loading, error } = useSelector((state: any) => state.warrantyTerm);
  // handle pagination
  ...
  const handlerDelete = async (id: number) => {
    try {
      await dispatch(deleteWarrantyTerm(id));
  ...
  useEffect(() => {
    dispatch(fetchWarrantyTerm({ activePage, searchValue }));
