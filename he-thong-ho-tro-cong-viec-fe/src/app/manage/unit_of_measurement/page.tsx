...
import Add_AddDonVitinh_Dialog from "./addDialong";
import Add_EditDonVitinh_Dialog from "./editDialong";
...
import {
    deleteDonViTinh,
    fetchDonViTinh,
} from "@/store/slices/donvitinh/donViTinhAction";
...
const arr = [
    ...
    { title: "Đơn Vị Tính", href: "/manage/donvitinh" },
];
export default function PagePage() {
    const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
    // API tác nhân
    const { items, loading, error } = useSelector((state: any) => state.donvitinh);
    // handle pagination
    ...
    const handlerDelete = async (id: string) => {
        try {
            await dispatch(deleteDonViTinh(id));
    ...
    useEffect(() => {
        dispatch(fetchDonViTinh({ activePage, searchValue }));
