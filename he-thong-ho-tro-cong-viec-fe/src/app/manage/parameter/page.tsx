...
import Add_Thongso_Dialog from "./addDialong";
import Edit_Thongso_Dialog from "./editDialong";
...
const arr = [
  ...
  { title: "Thông số", href: "/manage/thongso" },
];
export default function PagePage() {
  const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
  // API tác nhân
  const { items, loading, error } = useSelector((state: any) => state.thongso);
  // handle pagination
