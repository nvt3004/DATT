...
import Add_Agent_Dialog from "./addDialong";
import Edit_Agent_Dialog from "./editDialong";
...
const arr = [
    ...
    { title: "Tác nhân", href: "/manage/agent_used" },
];
export default function PagePage() {
    const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
    // API tác nhân
    const { items, loading, error } = useSelector((state: any) => state.agent);
    // handle pagination
            ...
            >
                ...
                <Table.Td style={{ padding: "10px" }}>
                    ...
                    {/* <Popover position="bottom" withArrow shadow="md">
                        <Popover.Target>
                            <Button variant="light">Xem mô tả</Button>
                        </Popover.Target>
                        <Popover.Dropdown>
                            <Text size="xs" > {item.moTa}</Text>
                        </Popover.Dropdown>
                    </Popover> */}
                </Table.Td>
