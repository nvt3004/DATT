...
import Add_Nhomchucnang_Dialog from "./addDialong";
import Edit_Nhomchucnang_Dialog from "./editDialong";
...
const arr = [
    ...
    { title: "Nhóm Chức Năng", href: "/manage/nhomchucnang" },
];
export default function PagePage() {
    const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
    // API tác nhân
    const { items, loading, error } = useSelector(
        (state: any) => state.nhomchucnang
    );
    // handle pagination
