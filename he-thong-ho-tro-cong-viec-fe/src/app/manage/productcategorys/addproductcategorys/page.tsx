...
import { addproductCategorys } from "@/store/slices/productcategorys/productcategorysAction";
import {
    ActionIcon,
    Box,
    Button,
...
const arr = [
    ...
    {
        title: "Thêm Sản phẩm - hạng mục",
        href: "/manage/productcategorys/addproductcategorys",
    },
];
function Addproductcategorys() {
    ...
    const handleSubmit = async (values: typeof form.values | any) => {
        try {
            ...
            const res = await dispatch(addproductCategorys(converData));
        ...
        <>
            <Box style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
                ...
                <Box className="py-2 px-2 bg-[#339af0] text-white rounded-md my-3">
                    <Input.Label size="17">Thêm Sản phẩm hạng mục </Input.Label>
                </Box>
...
export default Addproductcategorys;
