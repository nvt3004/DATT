...
import Add_Pay_Dialog from "./addDialong";
import Edit_pay_Dialog from "./editDialong";
import { useDispatch, useSelector } from "react-redux";
import { ThunkDispatch } from "redux-thunk";
import { deletePay, fetchPay } from "@/store/slices/pay/payAction";
...
const arr = [
    ...
    { title: "Phương thức thanh toán", href: "/manage/pay" },
];
export default function PagePage() {
    const dispatch = useDispatch<ThunkDispatch<any, any, any>>();
    // API phương thức thanh toán
    const { items, loading, error } = useSelector((state: any) => state.pay);
    // handle pagination
    ...
    useEffect(() => {
        dispatch(fetchPay({ activePage, searchValue }));
