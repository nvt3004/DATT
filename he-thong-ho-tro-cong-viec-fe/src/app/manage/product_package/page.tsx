...
import Add_ProductPackage_Dialog from "./addDialong";
import Edit_ProductPackage_Dialog from "./editDialong";
...
const arr = [
    ...
    { title: "Gói sản phẩm", href: "/manage/product_package" },
];
export default function PagePage() {
    ...
    // handle active
    const [activeValue, setActiveValue] = useState<ActiveValue | any>(
        undefined
    );
    ...
    const handlerDelete = async (id: string) => {
        try {
            await dispatch(deleteProductPackage(id));
                        ...
                        >
                            ...
                            >
                                <Table.Tr>
                                    ...
                                    <Table.Th>Gói sản phẩm</Table.Th>
